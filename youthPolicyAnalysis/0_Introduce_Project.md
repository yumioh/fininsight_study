...
- ### 개정 전 vs 개정 후 댓글 감정 분석 비교

개정 전 댓글에서는 "합니다", "감사합니다", "바랍니다", "힘내세요" 등의 동사와 "이런", "있는", "좋은", "많은" 등의 형용사가 응원, 감사, 가능성, 긍정적인 평가 등을 표현하는 데 많이 사용되었습니다. 반면, "하는", "해서", "하면", "하고" 등의 동사는 정부의 일이나 정책을 비판하는 데 사용되었습니다.

개정 후 댓글에서는 긍정적인 표현으로 "주세요", "하게", "갑니다", "하세요", "하겠습니다" 등의 동사가 주로 사용되었으며, 이는 주로 기대와 지지를 나타냈습니다. 그러나 형용사 "그런, 없고"는 비꼬는 맥락에서, "아니냐", "있나", "아님", "미친", "있네", "없어" 등의 표현은 비판적인 의견을 더욱 직접적으로 표현하는 데 사용되었습니다.***

***이를 통해 개정 후 댓글에서는 기대감과 함께 비판적인 의견이 더 직접적이고 강하게 표현되는 경향이 있음을 알 수 있습니다. 이는 청년기본법 개정 후에도 부정적 반응이 지속되며 강한 부정적 감정이 증가한 것으로 나타난 것을 알 수 있었습니다.***
...
> 청년 기본법 개정 전후로 긍정적, 부정적 댓글의 비율에 큰 차이가 없고, 부정적인 댓글이 90%에 달하는 것은 정책에 대한 불만이 여전히 크다는 것을 나타냅니다. 반면, 부정적 댓글에서는 지속적인 불만과 더불어 강한 어조의 부정적 감정이 증가하여, **정책의 효과에 대한 회의적인 반응이 높음을 알 수 있습니다. 이는 정책의 지속적 개선과 새로운 문제 해결이 필요함을 시사합니다.**

...
"""
keyword = "youth_act_2024"

# 특정 기간 설정
start_date = pd.to_datetime("2023-09-03")
...
#청년기본법 2020
youth_act_sentiment_2020 = pd.read_csv("./trendAnalysis/sentiment_data/sentiment_청년_day_al.csv")

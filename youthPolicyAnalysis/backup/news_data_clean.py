...
#merge한 파일 들고 오기 
all_news_df = pd.read_csv("./youthPolicyAnalysis/news_data/merged_정책_2024.csv")
# 결측지 제거 전 : 325870
...
news_content_df = all_news_df[["content",'inp_date','origin_url']]
...
# 전처리한 데이터 파일로 저장
filename = f'./youthPolicyAnalysis/data/news/processed_data_{subject}_{data_year}_0604.csv'
content_df_copy[['date','content','origin_url']].to_csv(filename, index=False, encoding='utf-8-sig')
